...
export default Env.rules({
  ...
  RABBITMQ_QUESTION_RECOMMENDATION_QUEUE_NAME: Env.schema.string(),
  RABBITMQ_QUESTION_RECOMMENDATION_BINDING_KEY: Env.schema.string(),
  RABBITMQ_QUESTION_RECOMMENDATION_EXCHANGE: Env.schema.string(),
})
